  ...
  return (
    <div className="card-fintech flex flex-col h-full min-h-[400px]">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <h2 className="text-2xl font-display font-bold text-foreground">{symbol}</h2>
          {livePrice && (
            <p className="text-xl font-mono font-bold tracking-tight text-muted mt-1">
              Live: {livePrice.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}
            </p>
          )}
        </div>
